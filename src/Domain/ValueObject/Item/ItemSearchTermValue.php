...
class ItemSearchTermValue implements ValueObjectInterface
{
    private const MIN_STRLEN = 2;
    private const MAX_STRLEN = 20;
    ...
    public function __construct(string $name)
    {
        ...
        if ($strlen < self::MIN_STRLEN || $strlen > self::MAX_STRLEN) {
            throw new DomainWrongEntityParamException('Wrong search term strlen');
        }
